...
/***/ 70933:
/*!*******************************************************************!*\
  !*** ./src/app/modules/core/router-gaurds/modified-form.guard.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ModifiedFormGuard": () => (/* binding */ ModifiedFormGuard)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _services_dialog_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @services/dialog.service */ 96819);
...
class ModifiedFormGuard {
    constructor(dialogService, translateService, userService) {
        this.dialogService = dialogService;
        this.translateService = translateService;
        this.userService = userService;
    }
    canDeactivate(component) {
        if (this.userService.IsLogged() && component && component.isDirty) {
            return this.dialogService
                .openConfirmationDialog({
                title: this.translateService.instant('POPUPS.FORM_EDIT_NOTIFY.TITLE'),
                multipleContent: [
                    this.translateService.instant('POPUPS.FORM_EDIT_NOTIFY.BODY', {
                        page: this.translateService.instant(component.page),
                    }),
                ],
                confirmBtnTitle: this.translateService.instant('POPUPS.FORM_EDIT_NOTIFY.1_YES'),
                cancelBtnTitle: this.translateService.instant('POPUPS.FORM_EDIT_NOTIFY.2_NO'),
            })
                .afterClosed();
        }
        return true;
...
ModifiedFormGuard.ɵfac = function ModifiedFormGuard_Factory(t) { return new (t || ModifiedFormGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_services_dialog_service__WEBPACK_IMPORTED_MODULE_0__.DialogService), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__.TranslateService), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_services_modules_user_services_user_service__WEBPACK_IMPORTED_MODULE_1__.UserService)); };
ModifiedFormGuard.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: ModifiedFormGuard, factory: ModifiedFormGuard.ɵfac, providedIn: 'root' });
...
/***/ 65279:
/*!********************************************************************************!*\
  !*** ./src/app/services/modules/bookings/dataservices/booking.data.service.ts ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "BookingDataService": () => (/* binding */ BookingDataService)
/* harmony export */ });
...
class BookingDataService extends _services_searchEngine_services_api_access_service__WEBPACK_IMPORTED_MODULE_0__.ApiAccessService {
    constructor() {
        super(...arguments);
        this.bookingsList = [];
    }
    setBookings(bookings) {
        this.bookingsList = JSON.parse(JSON.stringify(bookings));
    }
    getBookingsList() {
        return JSON.parse(JSON.stringify(this.bookingsList));
    }
    ...
    getBooking(customerId, bookingId, loader = true) {
        const params = {
            entity: 'customers',
            action: 'bookings',
            actionId: bookingId,
    ...
    cancelBooking(bookingId, itineraryIds) {
        const request = {
            id: bookingId,
        ...
        return this.apiCallObs(_core_constants_http_request_type__WEBPACK_IMPORTED_MODULE_1__.HttpRequestType.POST, params, request);
    }
    downloadBookingVoucher(bookingId) {
        const params = {
            entity: 'bookings',
            id: bookingId,
        ...
        this.showLoader(true);
        return this.apiCallObsOptions(_core_constants_http_request_type__WEBPACK_IMPORTED_MODULE_1__.HttpRequestType.GET, params, { responseType: 'blob' });
    }
    sendBookingMail(bookingId) {
        const params = {
            entity: 'bookings',
            id: bookingId,
            action: 'sendMail',
...
BookingDataService.ɵfac = /*@__PURE__*/ function () { let ɵBookingDataService_BaseFactory; return function BookingDataService_Factory(t) { return (ɵBookingDataService_BaseFactory || (ɵBookingDataService_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetInheritedFactory"](BookingDataService)))(t || BookingDataService); }; }();
BookingDataService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: BookingDataService, factory: BookingDataService.ɵfac, providedIn: 'root' });
...
/***/ 64701:
/*!*******************************************************************************!*\
  !*** ./src/app/services/modules/bookings/services/booking-service.service.ts ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class BookingServiceService {
    constructor(dialogService, translateService, tzCurrencyPipe) {
        this.dialogService = dialogService;
        this.translateService = translateService;
        this.tzCurrencyPipe = tzCurrencyPipe;
    }
    static getCartOptions(optionsIds, cartItems) {
    ...
    checkCancelOptions(optionsIds, cartItems) {
        const bookingOptions = BookingServiceService.getCartOptions(optionsIds, cartItems);
        if (bookingOptions.some((option) => option.cancelMode === 'denied')) {
        ...
        return this.dialogService
            ...
            multipleContent: [this.formCancellationMessage(bookingOptions)],
    ...
    formCancellationMessage(options) {
        ...
        for (const option of options) {
            ...
            message += this.translateService.instant(translationKey, { amt }) + '<br/><br/>';
        }
        if (message === '') {
...
BookingServiceService.ɵfac = function BookingServiceService_Factory(t) { return new (t || BookingServiceService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_services_dialog_service__WEBPACK_IMPORTED_MODULE_0__.DialogService), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__.TranslateService), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_shared_pipes_tz_currency_pipe__WEBPACK_IMPORTED_MODULE_1__.TzCurrencyPipe)); };
BookingServiceService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: BookingServiceService, factory: BookingServiceService.ɵfac, providedIn: 'root' });
...
/***/ 75913:
/*!***********************************************************************************!*\
  !*** ./src/app/services/modules/footer-pages/dataservice/footer-pages.service.ts ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FooterPagesService": () => (/* binding */ FooterPagesService)
/* harmony export */ });
/* harmony import */ var _core_constants_http_request_type__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @core/constants/http-request-type */ 82354);
...
class FooterPagesService extends _services_searchEngine_services_api_access_service__WEBPACK_IMPORTED_MODULE_1__.ApiAccessService {
    getPageContent(id) {
        const params = {
            entity: 'footerHTML',
            id,
        ...
        this.showLoader(true);
        return this.apiCallObs(_core_constants_http_request_type__WEBPACK_IMPORTED_MODULE_0__.HttpRequestType.GET, params);
    }
    downloadPDF() {
        const params = {
            entity: 'terms',
            id: 'download',
            action: this.settingsService.langCode,
            closeLoader: true,
        };
        this.showLoader(true);
        return this.apiCallObsOptions(_core_constants_http_request_type__WEBPACK_IMPORTED_MODULE_0__.HttpRequestType.GET, params, {}, { responseType: 'blob' });
    }
    sendContactForm(formData) {
        ...
        return this.apiCallObs(_core_constants_http_request_type__WEBPACK_IMPORTED_MODULE_0__.HttpRequestType.POST, params, formData);
    }
}
FooterPagesService.ɵfac = /*@__PURE__*/ function () { let ɵFooterPagesService_BaseFactory; return function FooterPagesService_Factory(t) { return (ɵFooterPagesService_BaseFactory || (ɵFooterPagesService_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetInheritedFactory"](FooterPagesService)))(t || FooterPagesService); }; }();
FooterPagesService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: FooterPagesService, factory: FooterPagesService.ɵfac, providedIn: 'root' });
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_opt_atlassian_pipelines_agent_build_trazler_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_opt_atlassian_pipelines_agent_build_trazler_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_opt_atlassian_pipelines_agent_build_trazler_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,_opt_atlassian_pipelines_agent_build_trazler_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
